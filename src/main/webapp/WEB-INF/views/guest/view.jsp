...
<body>
				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu dropdown-menu-right"
							...
							<a class="dropdown-item" href="list?id=0">공지사항</a> <a
								class="dropdown-item" href="list?id=1">FAQ</a>
						</div></li>
	...
	<div class="container">
		...
		<h1 class="mt-4 mb-3">
			커뮤니티 <small>${ article.board.boardName }</small>
		</h1>

		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="greeting">커뮤니티</a></li>
			<li class="breadcrumb-item active">${ article.board.boardName }</li>
		</ol>
		...
		<div class="row">
			...
			<div class="col-lg-9 mb-4" style="font-size: 12px;">
				...
				<hr />
				<div id="info">
					<span>번호:</span> <span>${ article.id }</span> <span>글쓴이:</span> <span>${ article.name }</span>
				...
				<hr />
				<div style="height: 50px; float: left; font-size: 12px;"> <a class="btn btn-secondary"
					href="list?${ pagination.queryString }" style="font-size: 12px;">
				...
				<div style="height: 50px; float: right; font-size: 12px;">
					<a class="btn btn-secondary"
						href="list?${ pagination.queryString }" style="font-size: 12px;">
						<i class="glyphicon glyphicon-list"></i> 수정
					</a> <a class="btn btn-danger"
						href="delete?id=${article.id}&${ pagination.queryString }" style="font-size: 12px;"  data-confirm-delete>
